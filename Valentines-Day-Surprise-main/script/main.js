...
document.querySelector('.yes-btn').addEventListener('click', function() {
    ...
    finalQuestion.innerHTML = 
        "<h2>🎉 Happy Valentine's Day meri pyaari Mahi 💝✨</h2>" +
        "<p>You've made my life filled with joy!✨😏</p>" +
        "<div style='margin-top: 2rem; font-size: 3rem'>💞🌟</div>"+
         "<br><br>" +
    "<button class='valentine-btn flowers-btn'>🌸 Open Your Flowers 🌸</button>";

// Redirect to flowers.html
document.querySelector('.flowers-btn').addEventListener('click', function () {
